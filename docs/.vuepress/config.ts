...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'System', // 必需
      link: 'www.baidu.com', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://s03.wemiquan.com/r/20221128/0f023c15d0aa4740a09028d8148cd51e.png',
      name: '이지은',
      slogan: '리즈언 (이지은)',
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'one-click-copy', // 代码块复制按钮
      {
        ...
        copyMessage: '복사에 성공했습니다', // default is 'Copy successfully and then paste it for use.'
